    ...
    >
      ...
      >
        ...
        <path
          ...
          opacity="0.2"
        />
        <circle cx="128.99" cy="60.52" r="21.63" fill="#9fa8da" opacity="0.1" />
        <circle cx="503.1" cy="26.38" r="21.63" fill="#9fa8da" opacity="0.1" />
        <circle
          cx="846.25"
          cy="111.83"
          r="21.63"
          ...
          opacity="0.1"
        />
        <circle cx="36.25" cy="258.85" r="36.25" fill="#9fa8da" opacity="0.1" />
        <circle cx="71" cy="437.85" r="36.25" fill="#9fa8da" opacity="0.1" />
        <circle
          cx="749.92"
          cy="279.96"
          r="36.25"
